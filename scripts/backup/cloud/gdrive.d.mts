import type { CloudEntry, UploadOpts } from './destination.mjs'
...
export function upload(ctx: Ctx, localPath: string, remoteName: string, onProgress?: (s: number, t: number) => void, opts?: UploadOpts): Promise<{ remoteId: string }>

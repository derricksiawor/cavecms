...
export const JWT_ISS_SESSION = 'cavecms.cms'
export const JWT_AUD_SESSION = 'cavecms.web'
export const JWT_ISS_PREVIEW = 'cavecms.preview'
export const JWT_AUD_PREVIEW = 'cavecms.preview'

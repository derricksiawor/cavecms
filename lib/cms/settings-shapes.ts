...
export const SETTINGS_SHAPES: Record<string, FieldShape[]> = {
  ...
  footer: [
    ...
    },
    {
      ...
      help: 'Each column is a heading with a list of links. Add a column, then add links under it (use the nest button, or drag a link). Promote a link to its own column with the arrow.',
      childrenKey: 'links',
      childLabelKey: 'text',
      childHrefKey: 'href',
      maxItems: 6,
    ...
    },
    {
      ...
      label: 'Show the newsletter signup',
      defaultValue: true,
      help: 'When off, the whole newsletter column is removed and the footer reflows to two columns.',
    },
    {
      kind: 'string',
    ...
    },
    {
      kind: 'color',
      key: 'accentColor',
      label: 'Heading accent colour (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
      help: 'Colour of the small uppercase column + newsletter headings. Leave empty for the footer tone’s default accent.',
    },
    {
      kind: 'color',
      key: 'ctaFillColor',
      label: 'Subscribe button fill (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
    },
    {
      kind: 'color',
      key: 'ctaTextColor',
      label: 'Subscribe button text (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
    },
    {
      kind: 'color',
      key: 'ctaHoverFillColor',
      label: 'Subscribe hover fill (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
    },
    {
      kind: 'color',
      key: 'ctaHoverTextColor',
      label: 'Subscribe hover text (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
    },
  ...
  site_header: [
    ...
    },
    {
      ...
      help: 'Add links to your top bar. Add sub-links under any link (use the nest button, or drag a sub-link) and they appear as a dropdown on your site. Leave a link’s “Goes to” blank to make it open the dropdown only.',
      parentHrefKey: 'href',
    ...
    },
    {
      kind: 'color',
      key: 'ctaFillColor',
      label: 'Button fill colour (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
      help: 'Background of the primary button. Leave empty to use the header tone’s default pill.',
    },
    {
      kind: 'color',
      key: 'ctaTextColor',
      label: 'Button text colour (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
    },
    {
      kind: 'color',
      key: 'ctaHoverFillColor',
      label: 'Button hover fill (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
      help: 'Background when the cursor is over the button. Leave empty to keep the fill steady (or the tone default when no fill is set).',
    },
    {
      kind: 'color',
      key: 'ctaHoverTextColor',
    ...
    },
    {
      ...
      max: 64,
      step: 1,
      help: 'Leave blank for the default full pill. 0 = square; e.g. 10 = rounded rectangle.',
    },
    {
      kind: 'color',
      key: 'navColor',
      label: 'Nav link colour (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
      help: 'Colour of the top-bar links. Leave empty to use the header tone’s default.',
    },
    {
      kind: 'color',
      key: 'navActiveColor',
      label: 'Active nav link colour (optional)',
      tokens: [],
      allowCustom: true,
      allowAlpha: false,
      help: 'Colour of the link for the page the visitor is on — also used as the hover colour of the other links.',
    },
  ],
